 ...
 * @method Article   setSiteId()           Sets the current record's "site_id" value
 * @method Article   setTitleGeneral()     Sets the current record's "title_general" value
 ...
 * @method Article   setDatePublished()    Sets the current record's "date_published" value
 * @method Article   setHtmlTitle()        Sets the current record's "html_title" value
 ...
 * @method Article   setMetaRobots()       Sets the current record's "meta_robots" value
 * @method Article   setSite()             Sets the current record's "Site" value
 * 
 * @package    s14cms
 * @subpackage model
