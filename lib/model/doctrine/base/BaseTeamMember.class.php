 ...
 * @method string     getMemberPosition()   Returns the current record's "member_position" value
 ...
 * @method TeamMember setSiteId()           Sets the current record's "site_id" value
 * @method TeamMember setTitleGeneral()     Sets the current record's "title_general" value
 * @method TeamMember setTitle()            Sets the current record's "title" value
 * @method TeamMember setMemberPosition()   Sets the current record's "member_position" value
 * @method TeamMember setFilename()         Sets the current record's "filename" value
 * @method TeamMember setDescription()      Sets the current record's "description" value
 * @method TeamMember setContent()          Sets the current record's "content" value
 * @method TeamMember setIsActive()         Sets the current record's "is_active" value
 * @method TeamMember setHtmlTitle()        Sets the current record's "html_title" value
 * @method TeamMember setMetaTitle()        Sets the current record's "meta_title" value
 * @method TeamMember setMetaDescription()  Sets the current record's "meta_description" value
 * @method TeamMember setMetaKeywords()     Sets the current record's "meta_keywords" value
 * @method TeamMember setMetaRobots()       Sets the current record's "meta_robots" value
 * @method TeamMember setSite()             Sets the current record's "Site" value
 * 
 * @package    s14cms
 * @subpackage model
...
abstract class BaseTeamMember extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('member_position', 'string', 511, array(
             'type' => 'string',
             'length' => 511,
             ));
