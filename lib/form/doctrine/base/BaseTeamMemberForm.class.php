...
abstract class BaseTeamMemberForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'member_position'  => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'member_position'  => new sfValidatorString(array('max_length' => 511, 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'TeamMember', 'column' => array('position', 'site_id')))
    );
